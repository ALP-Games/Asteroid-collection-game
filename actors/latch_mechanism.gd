...
@export var sound_min_volume_db: float = -10.0
...
@onready var gas_emission_effects_side: Array[GPUParticles3D] = [$Housing/GasEmissionEffectLeft, $Housing/GasEmissionEffectRight]
@onready var gas_emission_effect_front: GPUParticles3D = $Housing/GasEmissionEffectFront
@onready var gas_sound: AudioStreamPlayer3D = $Housing/GasSound
